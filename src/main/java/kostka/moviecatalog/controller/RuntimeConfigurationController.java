...
public class RuntimeConfigurationController {
    ...
    @PostMapping("/new")
    public RuntimeConfiguration create(@RequestBody @Valid final RuntimeConfigDto dto) {
        return runtimeConfigurationService.create(dto);
    }

    @PostMapping("/update")
    public RuntimeConfiguration updateConfiguration(
            @RequestBody final RuntimeConfigDto dto) throws JsonProcessingException {
